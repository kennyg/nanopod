...
NanoPod gives you the core functionality without that mess.
...
- Custom `nanopod` MCP server (inside container) provides scheduling tools
...
**NanoPod** - A reference to Clawdbot (now OpenClaw).
